                     ...
                     <div class="card-body">
                        <div class="row p-3">
                           <div class="col-2 text-center">
                              <img src="{{ asset('assets/home/img/icon/phone.svg') }}" alt="" class="img-fluid" style="height: 50px">
                           </div>
                           <div class="col-10">
               ...
               <div class="col-md-6 mb-4">
                  <div class="card h-100 rounded-4 card-contact" style="min-height: 250px; max-height: fit-content">
                     <div class="card-body">
                        <div class="row p-3">
                           <div class="col-2 text-center">
                              <img src="{{ asset('assets/home/img/icon/mail.svg') }}" alt="" class="img-fluid" style="height: 50px">
                           </div>
                           <div class="col-10">
               ...
               <div class="col-md-6 mb-4">
                  <div class="card h-100 rounded-4 card-contact" style="min-height: 250px; max-height: fit-content">
                     <div class="card-body">
                        <div class="row p-3">
                           <div class="col-2 text-center">
                              <img src="{{ asset('assets/home/img/icon/clock.svg') }}" alt="" class="img-fluid" style="height: 50px">
                           </div>
                           <div class="col-10">
      ...
      <div class="container py-5">
         <div class="row align-items-center">
            <div class="col-lg-5 mb-3">
               ...
               <div class="row">
                  <div class="col-2">
                     <img src="{{ asset('assets/home/img/icon/location-dot.svg') }}" alt="" class="img-fluid" style="height: 50px">
                  </div>
                  <div class="col-10">
