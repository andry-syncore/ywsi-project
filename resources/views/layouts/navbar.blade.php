<nav class="navbar navbar-expand-lg sticky-top {{ Route::is('home') ? 'bg-transparent navbar-dark' : 'bg-white' }}" id="navbar">
   <div class="container">
      <a class="navbar-brand" href="#">
         <img src="{{ asset('assets/home/img/logo.svg') }}" alt="Logo YWSI">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbar-ywsi">
         <div class="navbar-nav ms-auto">
            ...
            <form action="" method="get" class="mb-lg-0 mx-2 mb-3">
               <div class="input-group">
                  ...
                  <input type="text" class="form-control bg-grey-3" name="search" placeholder="Pencarian" value="{{ request()->search }}" style="border-radius: 0 20px 20px 0; border-width: 1px 1px 1px 0">
               </div>
            </form>
         </div>
      </div>
