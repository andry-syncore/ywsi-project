         ...
         <div class="row align-items-center">
            <div class="col-lg-6 mb-lg-0 mb-4">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/about/img-section-1.png') }}" alt="Gambar orang di sawah" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6">
         ...
         <div class="row">
            <div class="col-lg-6 mb-4">
               <div class="card card-body rounded-4 h-100 p-4">
                  <div class="row">
                     <div class="col-2">
                        <img src="{{ asset('storage/img/about/icon/info.svg') }}" alt="">
                     </div>
                     <div class="col-10">
            ...
            <div class="col-lg-6 mb-4">
               <div class="card card-body rounded-4 h-100 p-4">
                  <div class="row">
                     <div class="col-2">
                        <img src="{{ asset('storage/img/about/icon/pin.svg') }}" alt="">
                     </div>
                     <div class="col-10">
            ...
            <div class="col-lg-6 mb-4">
               <div class="card card-body rounded-4 h-100 p-4">
                  <div class="row">
                     <div class="col-2">
                        <img src="{{ asset('storage/img/about/icon/users.svg') }}" alt="">
                     </div>
                     <div class="col-10">
            ...
            <div class="col-lg-6 mb-4">
               <div class="card card-body rounded-4 h-100 p-4">
                  <div class="row">
                     <div class="col-2">
                        <img src="{{ asset('storage/img/about/icon/clock-gear.svg') }}" alt="">
                     </div>
                     <div class="col-10">
   ...
   <section id="empowerment-about">
      <div class="container py-5">
         <div class="row align-items-center">
            <div class="col-lg-6 mb-lg-0 mb-4">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/about/img-section-2.png') }}" alt="Gambar masyarakat" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6">
      ...
      <div class="row align-items-center justify-content-between mb-5">
         <div class="col-lg-6">
            <div class="position-relative overflow-hidden" style="border-radius: 0 15px 15px 0;">
               <img src="{{ asset('storage/img/about/banner-2.svg') }}" alt="" class="img-fluid w-100">
               <h1 class="head-1 text-light fw-600">Siapa tim ahli di balik Yayasan Wirausaha Sosial Indonesia?</h1>
            </div>
         </div>
         <div class="col-lg-6">
            <div class="rounded-3 overflow-hidden">
               <img src="{{ asset('storage/img/about/img-section-3.png') }}" alt="" class="img-fluid">
            </div>
         </div>
      </div>
               ...
               <div class="row text-lg-start text-center">
                  <div class="col-6 mb-5">
                     <div class="row align-items-center">
                        <div class="col-lg-4 mb-lg-0 mb-3">
                           <div class="rounded-3 overflow-hidden">
                              <img src="{{ asset('storage/img/about/team/img-rudy.png') }}" alt="Foto Rudy Suryanto, SE, PhD" class="img-fluid">
                           </div>
                        </div>
                        <div class="col-lg-5">
                  ...
                  <div class="col-6 mb-5">
                     <div class="row align-items-center">
                        <div class="col-lg-4 mb-lg-0 mb-3">
                           <div class="rounded-3 overflow-hidden">
                              <img src="{{ asset('storage/img/about/team/img-hendratmo.png') }}" alt="Foto Hendratmo" class="img-fluid">
                           </div>
                        </div>
                        <div class="col-lg-5">
                  ...
                  <div class="col-6">
                     <div class="row align-items-center">
                        <div class="col-lg-4 mb-lg-0 mb-3">
                           <div class="rounded-3 overflow-hidden">
                              <img src="{{ asset('storage/img/about/team/img-arinto.png') }}" alt="Foto Arinto Nugroho" class="img-fluid">
                           </div>
                        </div>
                        <div class="col-lg-5">
                  ...
                  <div class="col-6">
                     <div class="row align-items-center">
                        <div class="col-lg-4 mb-lg-0 mb-3">
                           <div class="rounded-3 overflow-hidden">
                              <img src="{{ asset('storage/img/about/team/img-khatami.png') }}" alt="Foto Khatami Angga Kusumah" class="img-fluid">
                           </div>
                        </div>
                        <div class="col-lg-5">
         ...
         const detailBio = (user) => {
            ...
            if (user == 'hendratmo') {
               return `<div class="row align-items-center">
                  <div class="col-2">
                     <div class="rounded-3 overflow-hidden">
                        <img src="{{ asset('storage/img/about/team/img-hendratmo.png') }}" alt="Foto Hendratmo (Mamok)" class="img-fluid">
                     </div>
                  </div>
                  <div class="col-10">
