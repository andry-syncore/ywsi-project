         ...
         <div class="row align-items-center">
            <div class="col-lg-6 mb-lg-0 mb-4">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/pelatihan/img-section-entrepreneurship-1.png') }}" alt="" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6">
         ...
         <div class="container py-5">
            <div class="row align-items-center">
               ...
               <div class="col-lg-6 mb-lg-0 order-0 order-lg-1 mb-4">
                  <div class="rounded-3 overflow-hidden">
                     <img src="{{ asset('storage/img/pelatihan/img-section-entrepreneurship-2.png') }}" alt="Gambar masyarakat" class="img-fluid">
                  </div>
               </div>
            </div>
         </div>
