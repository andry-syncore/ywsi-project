...
@section('content')
         ...
         <div class="row align-items-center">
            <div class="col-lg-6 mb-lg-0 mb-4">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/pelatihan/img-section-accompaniment-1.png') }}" alt="" class="img-fluid">
               </div>
            </div>
            <div class="col-lg-6">
   ...
   <section id="project-cycle">
      <div class="container py-5">
         <div class="row">
            <div class="col-12">
               <img src="{{ asset('storage/img/pelatihan/img-section-accompaniment-2.png') }}" alt="" class="img-fluid w-100">
            </div>
         </div>
      </div>
   </section>
