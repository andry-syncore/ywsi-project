                  ...
                  <div class="swiper-wrapper">
                     ...
                     <div class="swiper-slide rounded-3 overflow-hidden">
                        <div class="rounded-3 overflow-hidden">
                           <img src="{{ asset('storage/img/portfolio/project/slider-assessment.png') }}" alt="Gambar sandal" class="img-fluid">
                        </div>
                     </div>
                     <div class="swiper-slide rounded-3 overflow-hidden">
                        <div class="rounded-3 overflow-hidden">
            ...
            <div class="col-lg-4 order-0 order-lg-1 mb-lg-0 mb-4">
               <div class="position-sticky" style="top: 85px">
                  ...
                  <div class="d-flex align-items-center mt-3">
                     ...
                     <a href="" class="me-3"><img src="{{ asset('storage/img/icon/share-ig.svg') }}" alt=""></a>
                     <a href="" class="me-3"><img src="{{ asset('storage/img/icon/share-fb.svg') }}" alt=""></a>
                     <a href="" class="me-3"><img src="{{ asset('storage/img/icon/share-wa.svg') }}" alt=""></a>
                  </div>
               </div>
            </div>
         </div>
