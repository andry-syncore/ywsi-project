      ...
      <div class="bg-video">
         ...
         <div class="position-absolute start-0 end-0 top-0 bottom-0">
            <div class="position-relative">
               <img src="{{ asset('storage/img/homepage/banner-home.png') }}" alt="" class="img-fluid" style="width: 100%">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 mb-4">
               <div class="card-impact card card-body rounded-4 h-100 p-3 text-center shadow-sm">
                  <img src="{{ asset('storage/img/homepage/img-card-dampak-1.png') }}" alt="" class="img-fluid mb-4">
            ...
            <div class="col-lg-4 mb-4">
               <div class="card-impact card card-body rounded-4 h-100 p-3 text-center shadow-sm">
                  <img src="{{ asset('storage/img/homepage/img-card-dampak-2.png') }}" alt="" class="img-fluid mb-4">
            ...
            <div class="col-lg-4 mb-4">
               <div class="card-impact card card-body rounded-4 h-100 p-3 text-center shadow-sm">
                  <img src="{{ asset('storage/img/homepage/img-card-dampak-3.png') }}" alt="" class="img-fluid mb-4">
            ...
            <div class="col-lg-4 mb-4">
               <div class="card card-body rounded-4 h-100">
                  <div class="overflow-hidden rounded-4 mb-3">
                     <img src="{{ asset('storage/img/homepage/img-news-1.png') }}" alt="Gambar berita satu" class="img-fluid w-100">
                  </div>
