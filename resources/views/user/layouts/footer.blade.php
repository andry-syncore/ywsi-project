      ...
      <div class="container py-5">
         <div class="row">
            ...
            <div class="col-12 mb-3">
               <img src="{{ asset('storage/img/logo-white.svg') }}" alt="Logo YWSI">
            </div>
            ...
            <div class="col-md-6 col-lg-3 px-md-5 px-lg-0">
               ...
               <a href="" target="_blank" class="me-3"><img src="{{ asset('storage/img/icon/fb.svg') }}" class="mb-3" alt="Facebook"></a>
               <a href="" target="_blank" class="me-3"><img src="{{ asset('storage/img/icon/ig.svg') }}" class="mb-3" alt="Instagram"></a>
               <a href="" target="_blank" class="me-3"><img src="{{ asset('storage/img/icon/yt.svg') }}" class="mb-3" alt="Youtube"></a>
