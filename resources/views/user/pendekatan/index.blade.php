   ...
   <section id="approach-content">
      <div class="position-relative container py-5">
         <div class="row align-items-center">
            <div class="col-lg-5 order-lg-0 order-1">
               <div class="left-card-detail rounded-3 overflow-hidden">
                  <div class="rounded-3 overflow-hidden">
                     <img src="{{ asset('storage/img/pendekatan/bg-card.png') }}" alt="" class="img-fluid w-100">
                  </div>
            ...
            <div class="col-lg-7 order-0 mb-lg-0 order-lg-0 mb-3">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/pendekatan/img-section-1.png') }}" alt="Gambar section satu" class="img-fluid">
               </div>
            </div>
         </div>
      </div>
         ...
         <div class="position-relative container py-5">
            <div class="row align-items-center">
               <div class="col-lg-7 mb-lg-0 mb-3">
                  <div class="rounded-3 overflow-hidden">
                     <img src="{{ asset('storage/img/pendekatan/img-section-2.png') }}" alt="Gambar section dua" class="img-fluid">
                  </div>
               </div>
               <div class="col-lg-5">
                  <div class="right-card-detail rounded-3 overflow-hidden">
                     <div class="rounded-3 overflow-hidden">
                        <img src="{{ asset('storage/img/pendekatan/bg-card-1.png') }}" alt="" class="img-fluid w-100">
                     </div>
                     <div class="position-absolute start-0 top-0 p-5">
      ...
      <div class="position-relative container py-5">
         <div class="row align-items-center">
            ...
            <div class="col-lg-7 order-0 mb-lg-0 order-lg-0 mb-3">
               <div class="rounded-3 overflow-hidden">
                  <img src="{{ asset('storage/img/pendekatan/img-section-3.png') }}" alt="Gambar section tiga" class="img-fluid">
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="bg-f7">
         <div class="position-relative container py-5">
            <div class="row align-items-center">
               <div class="col-lg-7 mb-lg-0 mb-3">
                  <div class="rounded-3 overflow-hidden">
                     <img src="{{ asset('storage/img/pendekatan/img-section-4.png') }}" alt="Gambar section empat" class="img-fluid">
                  </div>
               </div>
               <div class="col-lg-5">
                  <div class="right-card-detail rounded-3 overflow-hidden">
